...
public class Doctor implements Serializable {
    ...
    public Doctor(Integer id_doc, String nombre_doc, String tipoUsuario, String cedula_doc, String apellido_doc, String nombreUsuario, String telefono_doc) {
        this.id_doc = id_doc;
...
//
//    public Doctor(Integer id, String nombre_doc, String tipoUsuario, String cedula_doc, String apellido_doc, String nombreUsuario, String telefono_doc, List<Paciente> listaPacientes) {
//        super(id,nombre_doc,tipoUsuario,cedula_doc,apellido_doc,nombreUsuario,telefono_doc);
